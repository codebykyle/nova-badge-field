...
/* harmony default export */ __webpack_exports__["a"] = ({
    methods: {
        backgroundColor: function backgroundColor(forValue) {
            ...
            var colorMapElement = this.field.colorMap[forValue];
        ...
        textColor: function textColor(forValue) {
            if (!this.field.hasOwnProperty('colorMap')) {
            ...
            var colorMapElement = this.field.colorMap[this.field.value];
        ...
        offsetColor: function offsetColor(color) {
            if (color.length < 5) {
                color += color.slice(1);
            }
...
Nova.booting(function (Vue, router) {
    Vue.component('index-badge', __webpack_require__(5));
    Vue.component('detail-badge', __webpack_require__(8));
    Vue.component('form-badge', __webpack_require__(11));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mixins_colors__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mixins_value__ = __webpack_require__(2);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mixins: [__WEBPACK_IMPORTED_MODULE_0__mixins_colors__["a" /* default */], __WEBPACK_IMPORTED_MODULE_1__mixins_value__["a" /* default */]]
});
...
var render = function() {
  ...
  return _c(
    "span",
    {
      staticClass: "rounded-full uppercase px-2 py-1 text-xs font-bold",
      style: {
        backgroundColor: _vm.backgroundColor(this.formattedValue),
        color: _vm.textColor(this.formattedValue)
      }
    },
    [_vm._v(_vm._s(_vm.__(this.formattedValue)))]
  )
}
var staticRenderFns = []
    ...
    [
      _c("template", { slot: "value" }, [
        _c(
          ...
          [_vm._v(_vm._s(_vm.__(_vm.field.formattedValue)))]
        )
      ])
    ],
    2
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_laravel_nova__ = __webpack_require__(13);
  ...
  return _c(
    ...
    [
      _c("template", { slot: "field" }, [
        ...
        _vm._v(" "),
        _vm.hasError
          ? _c("p", { staticClass: "help-text error-text mt-2 text-danger" }, [
